...
public class ToolboxLogHandler {
    public static InputStream extractLog(int index) throws Exception {
        ...
        return Util.addHeaderAndFooter("<?xml version=\"1.0\" encoding=\"UTF-8\"?><logs xmlns=\"http://pisa.intecs.it/mass/toolbox/log\" pagesNumber=\"" + pages + "\">", new FileInputStream(logFile), "</logs>");
    }
