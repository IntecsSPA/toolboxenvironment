...
public class NewInitializedTypedArrayTag extends NativeTagExecutor {
    ...
    public Object executeTag(org.w3c.dom.Element initializedArray) throws Exception {
        ...
        Object array = Array.newInstance((Class) this.executeChildTag((Element) children.removeFirst()), children.size());
