<!-- 
 ...
 -
 -->
<%@ page import="it.intecs.pisa.util.*,it.intecs.pisa.toolbox.service.*,it.intecs.pisa.common.tbx.*,it.intecs.pisa.soap.toolbox.*, java.util.*, it.intecs.pisa.toolbox.security.ToolboxSecurityConfigurator"  errorPage="errorPage.jsp" %>
                                        ...
                                        <tr><!-- Row 8  WS-SECURITY -->
		                                	...
		                                	<TBODY>
			                                    ...
			                                    <TR><!-- password -->
			                                        ...
			                                        <TD align=left width="20%"><INPUT type=password id="jksPasswordId" maxLength=40 size=30 name=jksPasswd value="<%=keystorePassword %>" <%= ws_security ? "": "disabled"%> > </TD>
			                                    	<TD>&nbsp;
			                                    	</TD>
			                                    </TR>
		                                    		...
		                                    		<td class="sortable" width="80%" colspan=1 nowrap>
                                                		<input type="file" name="xacmlFile" id="xacmlButton"  size="100%" />
                                            		</td> 
                                            		-->
                                            		
                                 				<tr><!-- XACML -->
			                                        	<td width="50%" rowspan="1" nowrap class="sortable"><input type="checkbox" id="XACMLcheckbox" name="XACMLFlag" <%= (XACMLUrl.length() != 0) ? "checked" : ""%> onclick="toggleXACML()" <%= ws_security ? "": "disabled"%> > 
			                                                                                               XACML	<font color="FF0000">
