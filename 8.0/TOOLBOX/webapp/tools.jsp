        ...
        <TR> 
            <TD class=pageBody id=main><SCRIPT>addBreadCrumb("<%=bc%>");</SCRIPT>
                <DIV class=portletItem id=01> 
                    ...
                    <P> 
                        <A href="createEbRRDB.jsp"><IMG class=labelHomePage title=Toolbox alt="Send a SOAP message" src="images/createDB.jpg" align=middle border=0></A>
                ...
                <DIV class=portletItem id=05>
                    ...
                    <P>
                        <A href="<%= response.encodeURL("ebrrHarvest.jsp?serviceName="+serviceName) %>"><IMG class=labelHomePage title=validate alt="" src="images/harvestHTTP.jpg" align=middle border=0></A>
                ...
                <DIV class=portletItem id=05>
                    ...
                    <P>
                        <A href="<%= response.encodeURL("ebrrHarvestFromDisk.jsp?serviceName="+serviceName) %>"><IMG class=labelHomePage title=validate alt="<fmt:message key="ebrr.harvestfromdisk" bundle="${lang}"/>" src="images/harvestFile.jpg" align=middle border=0></A>
