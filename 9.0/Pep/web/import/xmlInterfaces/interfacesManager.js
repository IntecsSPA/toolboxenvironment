...
InterfacesManager= function(lang, xmlClientLibPath, proxyUrl, utilsUrl) {
    ...
    this.loadGlobalScript= function(url, onLoadFn){
    ...
    this.loadGlobalCSS= function(url){
        if(!document.getElementById(url)){
    ...
    this.extjsImport= function(){
        ...
        /*EXTjs Import -- START*/
        // this.loadCSS("import/openExt/resources/css/ext-all.css");
        //Ext Theme
        // this.loadCSS("import/openExt/resources/css/xtheme-slate.css");
     ...
     if((agent.match("MSIE") || agent.match("Safari"))){
        ...
        //  this.loadScript("import/openExt/adapter/ext/ext-base.js",
        this.loadScript("import/ext/adapter/ext/ext-base.js",
            function(){
                // alert("ext-all import");
                //  interfacesManager.loadScript("import/openExt/ext-all.js",
                interfacesManager.loadScript("import/ext/ext-all.js",
                    ...
                    function(){
                        ...
                        interfacesManager.desktopImport();
                    }
                    );
            }
            );
    ...
    this.sarissaImport= function(){
        this.loadScript("import/sarissa/sarissa-compressed.js", function(){
            interfacesManager.loadScript("import/sarissa/sarissa_ieemu_xpath-compressed.js");
        });
    };
    ...
    this.desktopImport=function(){
        /*Desktop Modules*/
        interfacesManager.loadGlobalScript("scripts/desktop3/js/StartMenu.js",
         
            function(){
                interfacesManager.loadGlobalScript("scripts/desktop3/js/TaskBar.js");
                interfacesManager.loadGlobalScript("scripts/desktop3/js/Desktop.js");
                interfacesManager.loadGlobalScript("scripts/desktop3/js/App.js");
                interfacesManager.loadGlobalScript("scripts/desktop3/js/Module.js");
                interfacesManager.loadGlobalCSS("scripts/desktop3/css/desktop.css"); 
                interfacesManager.loadGlobalScript("scripts/desktopModules/desktopModule.js", 
                    function(){
                        interfacesManager.loadGlobalScript("scripts/desktopModules/pepServices.js");
                        interfacesManager.loadGlobalScript("scripts/desktopModules/pepServicesManager.js");
                        interfacesManager.loadGlobalScript("scripts/desktopModules/pepLog.js");
