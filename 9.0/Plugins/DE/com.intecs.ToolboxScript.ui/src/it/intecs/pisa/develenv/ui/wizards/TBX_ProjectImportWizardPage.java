 ...
 *
 */
public class TBX_ProjectImportWizardPage extends WizardPage implements Listener{
	
	private static final String BUNDLE_NAME = "com.intecs.ToolboxScript.ui";
	
	private FileInsertion fileIns=null;
		
	protected TBX_ProjectImportWizardPage(String pageName) {
		super(pageName);
	...
	private void createDirectoryRow(Composite parent) {
		...
		fileIns=new FileInsertion(parent,SWT.NULL,"Zip File:");
