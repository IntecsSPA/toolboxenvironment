...
<xsl:stylesheet version="1.0" xmlns:eoli="http://earth.esa.int/XML/eoli"
	...
	<xsl:template
		...
		<xsl:if
			...
			<sar:EarthObservationProduct gml:id="DS_2044263010822">
				...
				<sar:polarisationChannels>
					<xsl:value-of
						select="eoli:addInfo/eoli:locAtt/eoli:locName[text()='Polarisation']/../eoli:locValue" />
				</sar:polarisationChannels>
				<sar:beam>
					<xsl:value-of
						select="eoli:dataIdInfo/eoli:satDom/eoli:swathId" />
				</sar:beam>
