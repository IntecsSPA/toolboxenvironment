		...
		for (int j=0; j<rampConfnodeList.getLength(); j++){
			...
			for (int i=0; i<list.getLength(); i++){
				...
				if (el2.getAttribute("name").compareTo("org.apache.ws.security.crypto.merlin.file")==0){
					...
					if (el2.getAttribute("name").compareTo("org.apache.ws.security.crypto.merlin.keystore.password")==0){
						...
						if (el2.getAttribute("name").compareTo("org.apache.ws.security.crypto.merlin.keystore.alias")==0){
							...
							if (t!= null){
								...
								if (el2.getAttribute("name").compareTo("org.apache.ws.security.crypto.merlin.alias.password")==0){
