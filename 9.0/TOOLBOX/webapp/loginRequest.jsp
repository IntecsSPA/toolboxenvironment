...
<HTML lang=it><HEAD><TITLE>TOOLBOX - Login</TITLE>
    ...
    <BODY id=body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
                            ...
                            <TBODY>
                                ...
                                <TR>
                                    <TD>
                                        ...
                                        <TBODY>
                                        <TR bgColor=#607a92>
                                            <TD vAlign=bottom align=left bgColor=#000000 height=60><IMG
                                                    src="images/toolboxLogo.png"
                                                border=0></TD>
                                            <TD vAlign=bottom align=middle bgColor=#000000 height=60></TD>
                                            <TD vAlign=bottom align=right bgColor=#000000 height=60><IMG
                                        ...
                                        <TR class=flagcolour>
                                            <TD colSpan=3>
                                                <DIV class=mnu>
                                                    <TABLE id=menuTop width="100%" align=center bgColor=#000000
                                                           border=0>
                                                        <TBODY>
                                                            <TR align=middle>
        ...
        <div align=center>
            <a href="loginRequest.jsp?lang=en">English</a> - <a href="loginRequest.jsp?lang=it">Italiano</a> <br>
        </div>
        <DIV class=mnu>
