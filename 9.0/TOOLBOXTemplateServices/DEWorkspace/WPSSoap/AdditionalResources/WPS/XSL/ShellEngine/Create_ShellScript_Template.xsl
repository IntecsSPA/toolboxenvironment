...
# *OUTPUT_REPOSITORY : Output Repository Directory (This Folder should contain all the SHELL output files)
# *INPUT_REPOSITORY : Input Repository Directory (This Folder should contain all the Complex Data Input files)
...
# *TEMP_REPOSITORY : Temporaney Data Repository Directory (This Folder should contain all the temporaney files)		
# *WPS_PROCESSING_NAME: WPS Processing Name
# *INSTANCE_VALUE: Instance Operation Value (for multiple Instances)
# *SHELL_LOG_FILE: File path for SHELL text LOG		
