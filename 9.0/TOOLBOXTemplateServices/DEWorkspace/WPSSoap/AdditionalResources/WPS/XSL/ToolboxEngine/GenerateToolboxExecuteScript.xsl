    ...
    <sequence xmlns="http://pisa.intecs.it/mass/toolbox/xmlScript">
      ...
      <if>
        ...
        <sequence>
          ...
          <setVariable name="toolboxEnvironmentFile">
            <string>${wpsTempFolder}toolboxEnvironment.tscript</string>
          </setVariable>
          <mkdir>
            ...
            <sequence>
              <if>
                ...
                <sequence>
                  ...
                  <fork>
                    <sequence>
                      <xsl:if test="$downloadInputs = 'true'">
                      ...
                      <!-- Generate TOOLBOX environment  Toolbox Script /-->
                      <setVariable name="jobScript">
                        <xslt xmlOutput="true">
                          <variable name="processRequest"/>
                          <path startFrom="SERVICE_RESOURCE_DIR">
                            <string>../AdditionalResources/WPS/XSL/ToolboxEngine/Execute_ToolboxScript_Environment.xsl</string>
                          </path>
                          ...
                          <parameter name="toolboxOutputFolder">
                            <variable name="wpsOutputFolder"/>
                          </parameter>
                          <parameter name="toolboxTempFolder">
                            <variable name="wpsTempFolder"/>
                          </parameter>
                          <parameter name="toolboxScriptPath">
                            <path startFrom="SERVICE_RESOURCE_DIR">
                              <string>ToolboxScripts/</string>
                            </path>
                          </parameter>
                          <parameter name="toolboxLogFileInstance">
                            <string>${wpsLogFolder}/${wpsProcessingInstance}/ToolboxLog.txt</string>
                          </parameter>
                          <parameter name="downloadFolder">
                            <variable name="wpsDownloadedInputFolder"/>
                          </parameter>
                          <parameter name="downloadInputs">
                            <string>
                              <xsl:value-of select="$"/>
                            </string>
                          </parameter>
                          <parameter name="procedureFolder">
                            <path startFrom="SERVICE_RESOURCE_DIR">
                              <string>../AdditionalResources/WPS/Procedures/ToolboxEngine/</string>
                            </path>
                          </parameter>
                        </xslt>
                      </setVariable>
                      <dumpFile>
                        <path>
                          <variable name="toolboxEnvironmentFile"/>
                        </path>
                        ...
                        <oeq>
                          ...
                          <string>true</string>
		                        ...
		                        <sequence>
		                          ...
		                          <fork>
		                            <sequence>
		                              <setVariable name="currentPercentage"><string>0</string></setVariable>
		                              <!-- Output Control -->
                                      ...
                                      <parameter name="outputRepository"><variable name="wpsOutputFolder"/></parameter>
                                    </xslt>
                                  </setVariable>
                                  <dumpXML>
                                  ...
                                  <call procedure="OutputControlProcedure">
                                    <argument name="outputsControl"><string/></argument>
                                    <argument name="outputsException"><string/></argument>
                                    <argument name="outputsExceptionMessage"><string/></argument>
                                  </call>
                                  <!-- End Output Control-->
                                  <while>
                                    <and>
                                            ...
                                            <if>
                                              ...
                                              <sequence>
                                                <setVariable name="currentPercentage">
                                                  <variable name="newPercentage"/>
                                                    </setVariable><setVariable name="statusExecuteResponse">
                                                    ...
                                                    <xslt xmlOutput="true">
                                                      ...
                                                      <parameter name="creationTime"><dateStringFormatter format="yyyy-MM-dd'T'HH:mm:ss'Z'"><now/></dateStringFormatter></parameter>
