...
public class TOOLBOXProjectPropertyPage extends PropertyPage implements Listener{
	 ...
	 */
	public TOOLBOXProjectPropertyPage() {
		super();
	}
	...
	private void saveToolboxServerPreference() {
		...
		username=properties.getToolboxAuthUsername();
		password=properties.getToolboxAuthPassword();
		
		project=(IProject) this.getElement();
		ToolboxEclipseProjectPreferences.setToolboxHostURL(project,url);
		ToolboxEclipseProjectPreferences.setToolboxHostUsername(project, username);
		ToolboxEclipseProjectPreferences.setToolboxHostPassword(project, password);
	}
