...
public class PlusTag extends NativeTagExecutor{

	@Override
	public Object executeTag(org.w3c.dom.Element plus) throws Exception{
               Iterator values = null;
                int result = 0;
                Object firstValue=null;
                Object res=null;

            values=DOMUtil.getChildren(plus).iterator();
