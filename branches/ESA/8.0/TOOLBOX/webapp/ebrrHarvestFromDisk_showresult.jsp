                                    ...
                                    <TD id=main> <P class=arbloc><FONT class=arttl></FONT></P>
                                        ...
                                        <table width="450" cellspacing="2" cellpadding="2" align="center">
                                            <tr>
                                                ...
                                                <td class="sortable"  colspan=1 nowrap><fmt:message key="ebrr.harvestfromdisk.success" bundle="${lang}"/></td>
                                                <% } else {%> <td class="sortable"  colspan=1 nowrap><fmt:message key="ebrr.harvestfromdisk.failure" bundle="${lang}"/> <%= request.getParameter("error")%></td>
                                                <%
            }%>                             </tr>
                                        </table>
                                        </P>
