...
DataGridInterface=function(){
    ...
    this.restDataDeleteAllUrl="service/deleteall";
            ...
            tbar:[{
                ...
                handler : function(){
                    Ext.Msg.show({
                        ...
                        renderEl: this.renderEl,
                        restDeleteUrl: this.restDeleteUrl,
                        title:'ARMS: Remove items',
                        msg: "Do you really want to delete all items?",
                        buttons: Ext.Msg.YESNOCANCEL,
                        animEl: this.renderEl,
                        fn: function(buttonId,text,opt){
                            if(buttonId == "yes"){
                                ...
                                var deleteResponse= function(response){
                                    ...
                                    if(jsonData.success){
                                        ...
                                        Ext.Msg.show({
                                            title:'ARMS: Operation Error',
                                            buttons: Ext.Msg.OK,
                                            msg: 'Not items removed',
                                            animEl: this.renderEl,
                                            icon: Ext.MessageBox.ERROR
                                        });
