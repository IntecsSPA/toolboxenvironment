...
/**
   ToolboxRollingFileAppender extends FileAppender to backup the log files when
...
*/
public class ToolboxRollingFileAppender extends FileAppender {
  /**
  ...
  */
  ...
  public ToolboxRollingFileAppender() {
    super();
  }
  ...
  */
  public ToolboxRollingFileAppender(Layout layout, String filename, boolean append)
    throws IOException {
  ...
  public ToolboxRollingFileAppender(Layout layout, String filename)
    throws IOException {
...
//          file.renameTo(target);              
              ...
              System.out.println("Unable to rollover");
          }
        }
      }
