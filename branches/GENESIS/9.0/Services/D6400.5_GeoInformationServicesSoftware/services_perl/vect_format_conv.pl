...
if (!(defined ($unique_code) && defined ($input_file) && defined ($output_file))) {
...
Utils::execute("ogr2ogr $output_format $dataset_creation_option \"$ogr2ogr_output_dir/Output\" \"$input_file\"", $debug);
