          ...
          <ows:DCP>
            <ows:HTTP>
              <xsl:if test="ows:OperationsMetadata/ows:Operation[@name='GetCapabilities']/ows:DCP/ows:HTTP/ows:Get">
                <ows:Get xlink:type="simple" xlink:href="{$toolboxURL}{ows:OperationsMetadata/ows:Operation[@name='GetCapabilities']/ows:DCP/ows:HTTP/ows:Get/@xlink:href}"/>
              </xsl:if>
              <xsl:if test="ows:OperationsMetadata/ows:Operation[@name='GetCapabilities']/ows:DCP/ows:HTTP/ows:Post">
                <ows:Post xlink:type="simple" xlink:href="{$toolboxURL}{ows:OperationsMetadata/ows:Operation[@name='GetCapabilities']/ows:DCP/ows:HTTP/ows:Post/@xlink:href}"/>
              </xsl:if>
            </ows:HTTP>
          </ows:DCP>
        </ows:Operation>
          ...
          <ows:DCP>
            <ows:HTTP>
              <xsl:if test="ows:OperationsMetadata/ows:Operation[@name='DescribeProcess']/ows:DCP/ows:HTTP/ows:Get">
                <ows:Get xlink:type="simple" xlink:href="{$toolboxURL}{ows:OperationsMetadata/ows:Operation[@name='DescribeProcess']/ows:DCP/ows:HTTP/ows:Get/@xlink:href}"/>
              </xsl:if>
              <xsl:if test="ows:OperationsMetadata/ows:Operation[@name='DescribeProcess']/ows:DCP/ows:HTTP/ows:Post">
                <ows:Post xlink:type="simple" xlink:href="{$toolboxURL}{ows:OperationsMetadata/ows:Operation[@name='DescribeProcess']/ows:DCP/ows:HTTP/ows:Post/@xlink:href}"/>
              </xsl:if>
            </ows:HTTP>
          </ows:DCP>
        </ows:Operation>
          ...
          <ows:DCP>
            <ows:HTTP>
              <xsl:if test="ows:OperationsMetadata/Operation[@name='Execute']/DCP/HTTP/Get">
                <ows:Get xlink:type="simple" xlink:href="{$toolboxURL}{OperationsMetadata/Operation[@name='Execute']/DCP/HTTP/Get/@xlink:href}"/>
              </xsl:if>
              <xsl:if test="ows:OperationsMetadata/ows:Operation[@name='Execute']/ows:DCP/ows:HTTP/ows:Post">
                <ows:Post xlink:type="simple" xlink:href="{$toolboxURL}{ows:OperationsMetadata/ows:Operation[@name='Execute']/ows:DCP/ows:HTTP/ows:Post/@xlink:href}"/>
              </xsl:if>
            </ows:HTTP>
          </ows:DCP>
        </ows:Operation>
              ...
              <xsl:for-each select="$currentDescribeDocument/ProcessDescription/ows:Metadata">
                <ows:Metadata>
        			<xsl:attribute name="xlink:title">
	        			<xsl:value-of select="$currentDescribeDocument/ProcessDescription/ows:Metadata/@xlink:title"/>
	      			</xsl:attribute>
