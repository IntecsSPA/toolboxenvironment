...
public class RESTServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (requestURI.endsWith(METHOD_GET_STATUS)) {
            getItemStatus(request,response);
        }
        else if(requestURI.endsWith(METHOD_REVERSE_ID))
        {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        requestURI = request.getRequestURI();
        if (requestURI.endsWith(METHOD_STORE)) {
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        requestURI = request.getRequestURI();
        if (requestURI.endsWith(METHOD_DELETE)) {
    ...
    private void deleteItem(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            itemId=inputJson.get("id").getAsString();
        } catch (Exception ex) {
            logError(ex);
            response.sendError(HttpServletResponse.SC_BAD_REQUEST);
            return;
        ...
        try
        {
            ...
            else outputJson=getItemNotAvailableResponse();
        }
        catch(Exception e)
        {
            outputJson=new JsonObject();
