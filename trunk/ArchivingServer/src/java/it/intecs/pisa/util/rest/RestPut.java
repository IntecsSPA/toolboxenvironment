...
public class RestPut {
    ...
    public static JsonObject putAsJSON(URL rest_URL, Hashtable<String,String> headers, String user, String password,JsonObject content) throws Exception
    {
        JsonObject jsonResponse;
        InputStream inStream;
        InputStream contentStream;
     ...
     * @throws Exception
     */
    public static InputStream put(URL rest_URL, Hashtable<String,String> headers, String user, String password,InputStream content) throws Exception {
