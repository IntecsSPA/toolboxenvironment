 ...
 * @author Massimiliano
 */
public class RemoveBreakpointMessage extends StructuredMessage {
    protected static final String COMMAND_NAME = "removeBreakpoint";
    ...
    public RemoveBreakpointMessage() {
    }

    public RemoveBreakpointMessage(String file,String xpath) {
        setXPath(xpath);
         setFile(file);
    }
