 ...
 *
 */
public class TBX_PortalXSLImportWizardPage extends WizardPage implements Listener{
	
	protected static final String WIZARD_PAGE_DESCRIPTION = "This wizard lets you import the SSE stylesheet and associate it with the service. Once the service is deployed TOOLBOX Runtime Environment will customize some interface parts allowing a portal-like interaction.";

	private static final String BUNDLE_NAME = "com.intecs.ToolboxScript.ui";
	
	private FileInsertion fileIns=null;
		
	protected TBX_PortalXSLImportWizardPage(String pageName) {
		super(pageName);
	...
	private void createDirectoryRow(Composite parent) {
		...
		fileIns=new FileInsertion(parent,SWT.NULL,"SSE Stylesheet:");
