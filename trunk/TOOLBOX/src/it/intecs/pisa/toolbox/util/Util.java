...
public class Util {
  ...
  public static String getDateTime() {
      ...
      StringBuffer date = new StringBuffer().append(addZero(day)).append('-')
                          .append(addZero(month)).append('-').append(year)
                          .append(' ').append(addZero(hour)).append(':')
                          .append(addZero(minute)).append(':')
                          .append(addZero(second));
  ...
  public static void addSOAPEnvelope(Document document, String relatesTo) {
      ...
      relatesToElement = (Element) header.appendChild(document.createElementNS(WSA_URI, WSA + ":" + RELATES_TO));
