    ...
    <xsl:template match="/log:flow">
       ...
       <TR>
                    <TD id="main" align="middle">
                        ...
                        <a>
                            <xsl:attribute name="href">javascript:viewResource('xml','id=<xsl:value-of select="/log:flow/log:responseScriptExecution/@id"/>','Response builder Script')</xsl:attribute>
                            <img src="images/xml-icon.jpg" alt="XML view"/>
                        </a>
                        <a>
                            <xsl:attribute name="href">javascript:viewResource('tree','id=<xsl:value-of select="/log:flow/log:responseScriptExecution/@id"/>','Response builder Script')</xsl:attribute>
                            <img src="images/tree-icon.jpg" alt="tree view"/>
                        </a>
                        <a>
                            <xsl:attribute name="href">javascript:viewResource('text','id=<xsl:value-of select="/log:flow/log:responseScriptExecution/@id"/>','Response builder Script')</xsl:attribute>
                            <img src="images/download-icon.gif" alt="XML view"/>
                        </a>
                        )
                    </TD>
