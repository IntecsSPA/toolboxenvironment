...
<xsl:stylesheet version="1.0" xmlns:log="http://pisa.intecs.it/mass/toolbox/log" xmlns:tbx="http://pisa.intecs.it/mass/toolbox/toolbox" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ipo="http://www.mass.com/IPO" xmlns:h="http://www.mass.com/toolbox/help" xmlns:ss="http://pisa.intecs.it/mass/toolbox/serviceStatus" >
    ...
    <xsl:template match="/log:flow">
        ...
        <TR>
            <TD id="main" align="middle">
                <img src="images/send.faulted.jpg" alt="expired"></img>
                <br></br>
                <xsl:value-of select="$outputTxt"/>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('xml','id=<xsl:value-of select="/log:flow/log:invalidOutputMessage/@id"/>','Output Message')</xsl:attribute>
                    <img src="images/xml-icon.jpg" alt="XML view"/>
                </a>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('tree','id=<xsl:value-of select="/log:flow/log:invalidOutputMessage/@id"/>','Output Message')</xsl:attribute>
                    <img src="images/tree-icon.jpg" alt="tree view"/>
                </a>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('text','id=<xsl:value-of select="/log:flow/log:invalidOutputMessage/@id"/>','Output Message')</xsl:attribute>
                    <img src="images/download-icon.gif" alt="XML view"/>
                </a>
                )
            </TD>
