...
<xsl:stylesheet version="1.0" xmlns:log="http://pisa.intecs.it/mass/toolbox/log" xmlns:tbx="http://pisa.intecs.it/mass/toolbox/toolbox" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ipo="http://www.mass.com/IPO" xmlns:h="http://www.mass.com/toolbox/help" xmlns:ss="http://pisa.intecs.it/mass/toolbox/serviceStatus" >
    ...
    <xsl:template match="/log:flow">
        ...
        <TR>
            <TD id="main" align="middle">
                <img src="images/execute2.default.jpg" alt="execute second script"></img>
                <br></br>
                <xsl:value-of select="$sexecTxt"/>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('xml','id=<xsl:value-of select="/log:flow/log:secondScriptExecution/@id"/>','Operation Second Script')</xsl:attribute>
                    <img src="images/xml-icon.jpg" alt="XML view"/>
                </a>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('tree','id=<xsl:value-of select="/log:flow/log:secondScriptExecution/@id"/>','Operation Second Script')</xsl:attribute>
                    <img src="images/tree-icon.jpg" alt="tree view"/>
                </a>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('text','id=<xsl:value-of select="/log:flow/log:secondScriptExecution/@id"/>','Operation Second Script')</xsl:attribute>
                    <img src="images/download-icon.gif" alt="XML view"/>
                </a>
                )
            </TD>
        ...
        <TR>
            <TD id="main" align="middle">
                <img src="images/execute3.default.jpg" alt="execute second script"></img>
                <br></br>
                <xsl:value-of select="$texecTxt"/>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('xml','id=<xsl:value-of select="/log:flow/log:thirdScriptExecution/@id"/>','Operation Third Script')</xsl:attribute>
                    <img src="images/xml-icon.jpg" alt="XML view"/>
                </a>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('tree','id=<xsl:value-of select="/log:flow/log:thirdScriptExecution/@id"/>','Operation Third Script')</xsl:attribute>
                    <img src="images/tree-icon.jpg" alt="tree view"/>
                </a>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('text','id=<xsl:value-of select="/log:flow/log:thirdScriptExecution/@id"/>','Operation Third Script')</xsl:attribute>
                    <img src="images/download-icon.gif" alt="XML view"/>
                </a>
                )
            </TD>
        ...
        <TR>
            <TD id="main" align="middle">
                ...
                <a>
                    <xsl:attribute name="href">javascript:viewResource('xml','id=<xsl:value-of select="/log:flow/log:outputMessage/@id"/>','Output Message')</xsl:attribute>
                    <img src="images/xml-icon.jpg" alt="XML view"/>
                </a>
                <a>
                    <xsl:attribute name="href">javascript:viewResource('tree','id=<xsl:value-of select="/log:flow/log:outputMessage/@id"/>','Output Message')</xsl:attribute>
                    <img src="images/tree-icon.jpg" alt="tree view"/>
                </a>
                <a>
                ...
                <xsl:if test="$hasSSE='true'">
                    <a >
                        <xsl:attribute name="href">javascript:viewResource('SSEOutput','id=<xsl:value-of select="/log:flow/log:outputMessage/@id"/>')</xsl:attribute>
                        <img src="images/sse.png" alt="SSE"/>
                    </a>
                </xsl:if>
                <xsl:if test="$hasGML='true'">
                    <a>
                        <xsl:attribute name="href">javascript:viewResource('GMLOutput','id=<xsl:value-of select="/log:flow/log:outputMessage/@id"/>')</xsl:attribute>
