...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ows="http://www.opengis.net/ows/1.1">
 ...
 <xsl:param name="wpsExecuteSchemaFolder">test2</xsl:param>
	...
	<annotation>
  	...
  	<import schemaLocation="file:{$wpsSchemaLocation}" namespace="http://www.opengis.net/wps/1.0.0" />
	<!-- ==============================================================
		includes -->
  <xsl:for-each select="item">
    <include schemaLocation="file:{$wpsExecuteSchemaFolder}/{substring-before(substring-after(@text, '_'), '.')}.xsd"/> 
  </xsl:for-each>
		<!-- ============================================================== -->
