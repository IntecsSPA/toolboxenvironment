            ...
            <sequence>
              <if>
                ...
                <sequence>
                  ...
                  <fork>
                    <sequence>
                      <!-- Load  TOOLBOX Script defined from User /-->
                      <loadProcedure name="OperationTOOLBOXScript">
                        <path startFrom="SERVICE_RESOURCE_DIR">
                          <string>Common Scripts/Process_${executeProcessName}.tscript</string>
                        </path>
                      </loadProcedure>
                      ...
                      <!-- Call  TOOLBOX Script defined from User /-->
                      <call procedure="OperationTOOLBOXScript"/>
