          ...
          <TBODY> 
            <TR> 
              <TD id=main> <P class=arbloc>Copyrights</P> 
                  <p align="justify"><fmt:message key="copyrights.description" bundle="${lang}"/></p>
            </TD> 
            </TR> 
          </TBODY> 
        </TABLE></TD> 
...
<TABLE cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      href="aboutNotLogged.jsp?language=en"><fmt:message key="footer.about" bundle="${lang}"/></A> <A class=center
      href=""><fmt:message key="footer.copyright" bundle="${lang}"/></A> <A class=center
