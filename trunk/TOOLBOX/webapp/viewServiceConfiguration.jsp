...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center> 
    <TBODY>
        ...
        if (servInterface.getName().equals("")) {
            ...
            versionToPrint = servInterface.getName() + " version " + servInterface.getVersion();
        }
        ...
        for (String ss : serviceSchemas) {
            ...
            if (isRootSchema) {
                                    ...
                                    <tr>
                                        ...
                                        <font color="FFFFFF"><fmt:message key="viewConfiguration.rootSchema" bundle="${lang}"/></font></td>
                                        <td class="sortable" nowrap width="50%"><font color="FFFFFF"><%=ss%></font></td>
                                    </tr>
                                    <%
                                               } else {
