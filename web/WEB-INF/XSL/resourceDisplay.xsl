...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes">
    ...
    <xsl:param name="PanelResource">null</xsl:param>

    <xsl:variable name="charRepl"><xsl:text>'</xsl:text></xsl:variable>
    <xsl:variable name="PanelResourceParam" select="translate($PanelResource,$charRepl,'')"/>
    <xsl:template match="/">
		<HTML>
			<HEAD>
				<STYLE>
		...
		<SPAN class="att">
			<xsl:choose>
				<xsl:when test="name()='resourceKey'">
                               <a class="a" href="#" ONCLICK="javascript:parent.openTab('xml','Tab', 'manager?cmd=getResource&amp;panelResource={$PanelResourceParam}&amp;id={.}','XML '+'{.}', {$PanelResource})">
					Click here to display resource
			       </a>
				</xsl:when>
				<xsl:when test="name()='schemaLocation'">
                               <a class="a" href="#" ONCLICK="javascript:parent.openTab('xml','Tab', 'manager?cmd=getXMLRemoteResource&amp;panelResource={$PanelResourceParam}&amp;location={.}&amp;output=text','XML '+'{.}', {$PanelResource})">
					<xsl:value-of select="."/>
			       </a>
				</xsl:when>
